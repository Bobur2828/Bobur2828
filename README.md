...
<b>Я сделал свой первый шаг к своей цели, намереваясь стать программистом с целью сменить профессию, и записался на курс по языкам программирования Python в учебном центре Najot Ta'lim, где я прошел курсы по языку программирования Python и получил знания по PostgreSQL и Django Framework. Чтобы в будущем стать зрелым веб-разработчиком, я хотел бы добавить опыт работы в новых проектах, изучая свои вышеперечисленные знания на практике.
<b>
## 🌐Социальные сети
