...
# 💫Oбо мне :
<b><p>Я сделал свой первый шаг к своей цели,<p> 
<p>намереваясь стать программистом с целью <p>
<p>сменить профессию, и записался на курс по<p>
<p>языкам программирования Python в учебном<p>
<p>центре Najot Ta'lim, где я прошел курсы по<p>
<p>языку программирования Python и получил <p>
<p>знания по PostgreSQL и Django Framework.<p>
<p>Чтобы в будущем стать зрелым веб-разработчиком,<p>
<p>я хотел бы добавить опыт работы в новых проектах,<p>
<p>изучая свои вышеперечисленные знания на практике.<p>
<b>
## 🌐Социальные сети
